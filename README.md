...
Expert advice on building AI agents — covering the patterns, trade-offs, and techniques that matter most.
...
```
gh skill install NexusInitiative/AI-Agent-Advisor/skills/advise-rag
```
